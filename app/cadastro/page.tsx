...
export default function CadastroPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-navy p-6">
      <div className="relative flex w-full max-w-[380px] flex-col overflow-hidden rounded-[28px] bg-off-white shadow-2xl">
        <div className="relative flex flex-col items-center gap-3.5 bg-gradient-to-br from-navy to-navy-2 px-8 pb-10 pt-14">
          <BackButton light />
          <EloMark size={52} />
